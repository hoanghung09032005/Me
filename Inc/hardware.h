...
/* [THEM] Dung de mode3_follow.c xac nhan mot phep do MOI da thuc su hoan
 * tat, thay vi doan mo bang so tick co dinh - xem giai thich chi tiet o
 * hardware.c (HCSR04_Service) va mode3_follow.c (ROUND_MEASURE_WAIT). */
...
#define MOTOR_RIGHT_COMPENSATION_PCT 115
